...
class Book {
   ...
   /**
    * Check if the book is borrowed by somebody
    * @return true if some patron is reading this book now, false otherwise
    */
   boolean isBorrowed()
   {
    ...
    * value and its educational value. Very useful function.
    */
