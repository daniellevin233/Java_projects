...
public class Main {
	...
	public static void main(String[] args) {
		...
		if (exercisePart.equals("A") || exercisePart.equals("a")) {
            ...
            long eSortJoinStartTime = System.nanoTime();
			e.joinAndSelect(in1, in2, out, substrSelect, tmpPath);
            System.out.println("Sort, join and select execution time: " + (double) (System.nanoTime() - eSortJoinStartTime) / 1_000_000_000 + " seconds");
        }
            ...
            System.out.println("Sort, join and efficient select execution time: " + (double) (System.nanoTime() - eSortJoinStartTime) / 1_000_000_000 + " seconds");
		}
