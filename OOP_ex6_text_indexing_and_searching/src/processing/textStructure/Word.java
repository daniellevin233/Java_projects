...
public class Word implements Serializable {
	...
	protected String extractWord() throws IOException {
		this.srcBlk.getRAF().seek(this.srcBlkOffset);
		byte[] b = new byte[this.length];
		this.srcBlk.getRAF().read(b);
		return new String(b);
	}
	...
	/**
	 * The source block offset within the file + the offset of the word within the block = offset
	 * within an entry!
